...
export default async function RootLayout({
  ...
  const builtWith = dict.person.name === "Farrel Amroe Azhari" ? (dict as { footer?: { builtWith?: string; by?: string } }).footer?.builtWith || "built with" : "built with";
  const by = dict.person.name === "Farrel Amroe Azhari" ? (dict as { footer?: { builtWith?: string; by?: string } }).footer?.by || "by" : "by";
    ...
    <Providers>
        ...
        >
          <RevealFx fill position="absolute">
            ...
            <Footer builtWith={builtWith} by={by} />
            <Analytics />
            <CommandPalette />
            <EasterEgg />
            <BackToTop />
