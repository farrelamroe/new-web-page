const data = [
  ...
  {
    title: "Binar Academy - BSD City, Tangerang, Banten",
  ...
  },
  {
    ...
    achievement: (
      <ul className="custom-list-disc">
        <li>
          Provided comprehensive IT support, including the maintenance of the
          WordPress-based main website and all on- premise hardware (computers,
          printers, and network infrastructure).
        </li>
        <li>
          Managed and administered the Human Resource Information System (HRIS),
          ensuring the integrity and development of data records for over 100
          employees and administrators.
        </li>
        <li>
          Developed and enhanced features for the custom- built HRIS, such as
          implementing a new employee leave application module using PHP, HTML,
          and CSS.
        </li>
        <li>
          Oversaw the general management and operation of existing information
          systems to ensure stability and support for daily cooperative
          operations.
        </li>
      </ul>
    ),
